...
/******/ 	__webpack_require__.p = "C:\\ProjetsSeaters\\seaters-js/dist";
/******/
...
var FanApi = /** @class */function () {
    ...
    FanApi.prototype.hasGeoFilteredWaitingLists = function (fanGroupId) {
        return this.apiContext.get('v2/fan/groups/:fanGroupId/filter-info', { fanGroupId: fanGroupId }, { groupId: fanGroupId });
    };
    ...
    FanApi.prototype.getWaitingListsAsFGO = function (fanGroupId, searchOptions, pagingOptions) {
        var queryParams = seaters_api_1.SeatersApiContext.buildPagingQueryParams(pagingOptions);
        return this.apiContext.put('/fan-group-owner/groups/:fanGroupId/waiting-lists/search', searchOptions, { fanGroupId: fanGroupId }, queryParams);
    };
    ...
    FanApi.prototype.draftWaitingList = function (waitingListId) {
        return this.apiContext.put('/fan-group-owner/waiting-lists/:waitingListId/draft', null, { waitingListId: waitingListId }, null);
    };
    FanApi.prototype.openWaitingList = function (waitingListId) {
        return this.apiContext.put('/fan-group-owner/waiting-lists/:waitingListId/open', null, { waitingListId: waitingListId }, null);
    };
    FanApi.prototype.closeWaitingList = function (waitingListId) {
        return this.apiContext.put('/fan-group-owner/waiting-lists/:waitingListId/close', null, { waitingListId: waitingListId }, null);
    };
    ...
    FanApi.prototype.getFanAttribute = function (fanId) {
        return this.apiContext.get('v2/fan-group-owner/fan/:fanId/attirbutes?user_fan_attribute_status=LINKED', { fanId: fanId }, null);
    };
    FanApi.prototype.getFanInterests = function (fanId) {
        return this.apiContext.get('v2/fan-group-owner/fan/:fanId/interests??user_interest_status=LIKE&user_interest_status=DISLIKE&user_interest_status=NEUTRAL&size=9999', { fanId: fanId }, null);
    };
    FanApi.prototype.getFanActivities = function (fanId, fanGroupId) {
        return this.apiContext.get('v2/fan-group-owner/fan/:fanId/groups/:fanGroupId', { fanId: fanId, fanGroupId: fanGroupId }, null);
    };
    ...
    FanApi.prototype.getUserInterests = function (pagingOptions) {
        return this.apiContext.get("v2/fan/interests", {}, seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions));
    };
    /**
    ...
    FanApi.prototype.getUserFanAttributes = function (pagingOptions) {
        return this.apiContext.get("v2/fan/fan-attributes", {}, seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions));
    };
    /**
    ...
    FanApi.prototype.linkWaitingListInterest = function (waitingListId, interestId) {
        return this.apiContext.post("v2/fan-group-owner/waiting-lists/" + waitingListId + "/interests/" + interestId + "/link", {}, {});
    };
    FanApi.prototype.linkWaitingListFanAttribute = function (waitingListId, fanAttributeId) {
        return this.apiContext.post("v2/fan-group-owner/waiting-lists/" + waitingListId + "/fan-attributes/" + fanAttributeId + "/link", {}, {});
    };
    FanApi.prototype.unlinkWaitingListInterest = function (waitingListId, interestId) {
        return this.apiContext.post("v2/fan-group-owner/waiting-lists/" + waitingListId + "/interests/" + interestId + "/unlink", {}, {});
    };
    FanApi.prototype.unlinkWaitingListFanAttribute = function (waitingListId, fanAttributeId) {
        return this.apiContext.post("v2/fan-group-owner/waiting-lists/" + waitingListId + "/fan-attributes/" + fanAttributeId + "/unlink", {}, {});
    };
    // BADGE : FAN
    ...
    FanApi.prototype.getUserBadges = function (fanGroupId, userId, pagingOptions) {
        return this.apiContext.get('v2/fan-group-owner/groups/' + fanGroupId + '/badges/users/' + userId, null, seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions));
    };
    FanApi.prototype.getFanGroupBadges = function (fanGroupId, pagingOptions) {
        return this.apiContext.get('v2/fan-group-owner/groups/' + fanGroupId + '/badges', null, seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions));
    };
    ...
    FanApi.prototype.getWLBadges = function (waitingListId, pagingOptions) {
        return this.apiContext.get('v2/fan-group-owner/waiting-lists/' + waitingListId + '/badges', null, seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions));
    };
    // BADGE : ADMIN
    // SURVEY : FAN
    /**
    ...
    FanApi.prototype.getAnswers = function (surveyInstanceId) {
        return this.apiContext.get('v2/fan/surveys/instances/:surveyInstanceId/answers', { surveyInstanceId: surveyInstanceId });
    };
    /**
    ...
    FanApi.prototype.submitAnswers = function (surveyInstanceId, answers) {
        return this.apiContext.post('v2/fan/surveys/instances/:surveyInstanceId/answers', { answers: answers }, { surveyInstanceId: surveyInstanceId });
    };
    // SURVEY : FGO
    /**
     * Gets list of surveys per wishlist
    ...
    FanApi.prototype.getWaitingListSurveys = function (waitingListId, pagingOptions) {
        var queryParams = seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions);
        return this.apiContext.get('v2/fan-group-owner/waiting-lists/:waitingListId/surveys/instances', { waitingListId: waitingListId }, queryParams);
    };
    /**
    ...
    FanApi.prototype.getUserAnswers = function (waitingListId, surveyInstanceId, pagingOptions) {
        var queryParams = seaters_api_1.SeatersApiContext.buildPagingSortingQueryParams(pagingOptions);
        return this.apiContext.get('v2/fan-group-owner/waiting-lists/:waitingListId/surveys/instances/:surveyInstanceId/answers', { waitingListId: waitingListId, surveyInstanceId: surveyInstanceId }, queryParams);
    };
...
var WaitingListService = /** @class */function () {
        ...
        return this.getPositionPaymentInfo(waitingListId).then(function (paymentInfo) {
            ...
            return _this.positionBraintreeToken(waitingListId).then(function (braintreeToken) {
                ...
                return __assign({}, paymentInfo.braintreeConfig, {
                    // Transaction
                    currency: paymentInfo.transactions[0].currency, total: paymentInfo.transactions[0].total,
                    // Payment method helpers
                    masterpassEnabled: !paymentInfo.braintreeConfig.threeDSEnabled && paymentInfo.braintreeConfig.paymentMethods.indexOf(GROUP_PAYMENT_METHODS.MASTERPASS) !== -1,
    ...
    WaitingListService.prototype.leaveWaitingList = function (waitingListId) {
        ...
        return this.api.fan.leaveWaitingList(waitingListId).then(function () {
            return _this.pollWaitingList(waitingListId, function (wl) {
                return wl.actionStatus !== WAITING_LIST_ACTION_STATUS.WAIT && wl.actionStatus !== WAITING_LIST_ACTION_STATUS.CONFIRM && wl.actionStatus !== WAITING_LIST_ACTION_STATUS.GO_LIVE;
            });
        });
    };
    ...
    WaitingListService.prototype.saveAttendeesInfo = function (waitingListId, attendeesInfo) {
        var _this = this;
        return this.api.fan.updateAttendeesInfo(waitingListId, attendeesInfo).catch(function (e) {
    ...
    WaitingListService.prototype.extendRawWaitingList = function (wl) {
        return __assign({}, wl, { actionStatus: this.getWaitingListActionStatus(wl),
            // (T)ODO: pending status
            shouldProvideAttendeesInfo: this.shouldProvideAttendeesInfo(wl), processing: undefined });
    };
            ...
            if (seat) {
                if (seat.status === 'ASSIGNED' || seat.status === 'ASSIGNED_WITHOUT_SEATS') {
                    ...
                    if (waitingList.freeWaitingList) {
                        ...
                        // failed payment
                        return WAITING_LIST_ACTION_STATUS.CONFIRM;
                    } else if (['CREATING', 'CREATED', 'APPROVED', 'REFUNDING', 'PENDING'].indexOf(position.transactionStatus) >= 0) {
                        // payment in progress
    ...
    WaitingListService.prototype.removePreviousTransactionIfAny = function (wl) {
        ...
        return this.api.fan.deletePositionSalesTransaction(wl.waitingListId).then(function () {
            return _this.pollWaitingList(wl.waitingListId, function (updatedWl) {
...
var FanGroupService = /** @class */function () {
    ...
    FanGroupService.prototype.extendRawFanGroups = function (fgs) {
        var _this = this;
        return __assign({}, fgs, { items: fgs.items.map(function (fg) {
                return _this.extendRawFanGroup(fg);
            }) });
    };
...
function writeBinaryPostData(req, filepath) {
    ...
    var multipartBody = Buffer.concat([new Buffer(delimeter + crlf + headers.join('') + crlf), data, new Buffer(closeDelimeter)]);
    req.setHeader('Content-Type', 'multipart/form-data; boundary=' + boundary);
    req.setHeader('Content-Length', multipartBody.length);
    req.write(multipartBody);
}
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./../../node_modules/buffer/index.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).Buffer))
...
})(ProfilingFanAttributeStatusEnum = exports.ProfilingFanAttributeStatusEnum || (exports.ProfilingFanAttributeStatusEnum = {}));
...
})(ProfilingFanAttributeActionStatusEnum = exports.ProfilingFanAttributeActionStatusEnum || (exports.ProfilingFanAttributeActionStatusEnum = {}));
...
})(UserInterestActionStatusEnum = exports.UserInterestActionStatusEnum || (exports.UserInterestActionStatusEnum = {}));
...
})(UserFanAttributeActionStatusEnum = exports.UserFanAttributeActionStatusEnum || (exports.UserFanAttributeActionStatusEnum = {}));
...
var AdminApi = /** @class */function (_super) {
    ...
    AdminApi.prototype.getFanGroupProtectionCodes = function (fanGroupId, page) {
        return this.apiContext.get('/seaters-admin/fan-groups/:id/protection-codes', { id: fanGroupId }, seaters_api_1.SeatersApiContext.buildPagingQueryParams(page));
    };
    AdminApi.prototype.getFanGroupWaitingLists = function (fanGroupId, page) {
        return this.apiContext.get('/seaters-admin/fan-groups/:id/waiting-lists', { id: fanGroupId }, seaters_api_1.SeatersApiContext.buildPagingQueryParams(page));
    };
    ...
    AdminApi.prototype.deleteFanGroupProtectionCode = function (fanGroupId, code) {
        return this.apiContext.delete('/seaters-admin/fan-groups/:id/protection-codes/:code', { id: fanGroupId, code: code });
    };
    ...
    AdminApi.prototype.requestOneTimeFileUpload = function (fileName) {
        return this.apiContext.put('/seaters-admin/request-one-time-upload', null, null, fileName ? { fileName: fileName } : null);
    };
    /**
    ...
    AdminApi.prototype.getCategories = function (options) {
        return this.apiContext.get('/v2/seaters-admin/categories', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getInterests = function (options) {
        return this.apiContext.get('/v2/seaters-admin/interests', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getFanAttributes = function (options) {
        return this.apiContext.get('/v2/seaters-admin/fan-attributes', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getAllBadges = function (status, options) {
        return this.apiContext.get('v2/seaters-admin/badges' + (status ? '?status=' + status : ''), null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getBadgeCategories = function (status, options) {
        return this.apiContext.get('v2/seaters-admin/badges/category' + (status ? '?status=' + status : ''), null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getSurveys = function (options) {
        return this.apiContext.get('/v2/seaters-admin/surveys', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getSurveyInstances = function (options) {
        return this.apiContext.get('/v2/seaters-admin/surveys/instances', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getAnswerSemantics = function (options) {
        return this.apiContext.get('/v2/seaters-admin/surveys/answer-semantics', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getQuestions = function (options) {
        return this.apiContext.get('/v2/seaters-admin/surveys/questions', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(options));
    };
    ...
    AdminApi.prototype.getVenueConfig = function (venueId) {
        return this.apiContext.get('/seaters-admin/venues/:id/configs/', { id: venueId }, seaters_api_1.SeatersApiContext.buildPagingQueryParams(new paging_options_1.PagingOptions(0)));
    };
    ...
    AdminApi.prototype.requestFanGroupImageUpload = function (fanGroupId, endpoint, fileName) {
        return this.apiContext.put('/seaters-admin/fan-groups/:id/' + endpoint, null, { id: fanGroupId }, { fileName: fileName });
    };
    return AdminApi;
...
var TicketingApi = /** @class */function (_super) {
    ...
    TicketingApi.prototype.getTicketingSystems = function (page) {
        return this.apiContext.get('/ticketing/systems', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(page));
    };
...
var PaymentApi = /** @class */function (_super) {
    ...
    PaymentApi.prototype.getPaymentSystems = function (page) {
        return this.apiContext.get('/seaters-admin/payment-systems', null, seaters_api_1.SeatersApiContext.buildPagingQueryParams(page));
    };
    ...
    PaymentApi.prototype.updatePaymentSystem = function (paymentSystemId, payload) {
        return this.apiContext.put('/seaters-admin/payment-systems/:id', __assign({}, payload), { id: paymentSystemId });
    };
...
(function (SeatersExceptionV3) {
    ...
    function seatersExceptionV3Mapper(res) {
        try {
            ...
            if (error.errors.detectedErrorTypes.filter(function (e) {
                return e !== 'validation_errors';
            }).length > 0) {
                console.error('[SeatersExceptionV3] input error contains unsupported error type');
                throw error;
            }
            var message = error.errors.errorsTypes.validation_errors.map(function (e) {
...
var FanService = /** @class */function (_super) {
    ...
    FanService.prototype.getWaitingListsInFanGroups = function (fanGroupIds, pagingOptions, keyWords) {
        var _this = this;
        return this.waitingListService.getWaitingListsInFanGroups(fanGroupIds, pagingOptions, keyWords).then(function (r) {
            return _this.convertPagedResult(r);
        });
    };
    ...
    FanService.prototype.getWaitingListFanAttributes = function (waitingListId, pagingOptions) {
        return this.waitingListService.getWaitingListFanAttributes(waitingListId, pagingOptions).then(this.convertPagedSortedResult);
    };
...
var PublicService = /** @class */function () {
    ...
    PublicService.prototype.searchSeatersContent = function (query, locale, page, options) {
        ...
        return this.algoliaForSeatersService.searchSeatersContent(query, locale, page.maxPageSize, page.page, options).then(function (result) {
            return _this.convertAlgoliaResultSet(result);
        }).then(function (result) {
    ...
    PublicService.prototype.getWaitingListActionStatus = function (waitingList) {
        // Coming soon
        if (waitingList.waitingListStatus === 'PUBLISHED' || waitingList.waitingListStatus === 'SETUP' || waitingList.waitingListStatus === 'DRAFT') {
...
var FAN_GROUP_FACET_FILTER = { facet: algolia_for_seaters_types_1.TYPE_FIELD, value: algolia_for_seaters_types_1.FG_ALGOLIA_TYPE };
...
var SessionService = /** @class */function () {
    ...
    SessionService.prototype.doVerifyOAuth = function (input) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.seatersApi.authentication.verifyOAuth(input).then(function (r) {
                return _this.finishLogin(r);
            }).then(function (r) {
                return resolve(r);
            }).catch(function (r) {
    ...
    SessionService.prototype.doPasswordReset = function (email) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.seatersApi.authentication.resetPassword({ email: email }).then(function (r) {
                return resolve();
            }).catch(function (r) {
                return reject(r);
            });
...
var AppService = /** @class */function () {
    ...
    AppService.prototype.generateCity = function (administrativeArea2, sublocality, localityLevel1, localityName, postalTownName) {
        var city = '';
...
var AdminService = /** @class */function (_super) {
    ...
    AdminService.prototype.updateFanGroupBackgroundImage = function (fanGroupId, data, fileName) {
        var _this = this;
        return this.seatersApi.admin.requestFanGroupBackgroundImageUpload(fanGroupId, this.defaultFileName(fileName)).then(function (otf) {
    ...
    AdminService.prototype.updateFanGroupCoverImage = function (fanGroupId, data, fileName) {
        var _this = this;
        return this.seatersApi.admin.requestFanGroupCoverImageUpload(fanGroupId, this.defaultFileName(fileName)).then(function (otf) {
            return _this.seatersApi.admin.uploadOneTimeFile(otf.url, data);
        }).then(function () {
            return _this.getFanGroup(fanGroupId);
        });
    ...
    AdminService.prototype.updateFanGroupProfileImage = function (fanGroupId, data, fileName) {
        var _this = this;
        return this.seatersApi.admin.requestFanGroupProfileImageUpload(fanGroupId, this.defaultFileName(fileName)).then(function (otf) {
            return _this.seatersApi.admin.uploadOneTimeFile(otf.url, data);
        }).then(function () {
            return _this.getFanGroup(fanGroupId);
        });
    ...
    AdminService.prototype.updateEventImage = function (eventId, data, fileName) {
        var _this = this;
        return this.seatersApi.admin.requestEventImageUpload(eventId, this.defaultFileName(fileName)).then(function (otf) {
            return _this.seatersApi.admin.uploadOneTimeFile(otf.url, data);
        }).then(function () {
...
function mapWaitingList(wl) {
    return __assign({}, wl, { distributionRate: wl.billingVariables.distributionRate, vatRate: wl.billingVariables.vatRate, minDistributionFee: wl.billingVariables.minDistributionFee, maxDistributionFee: wl.billingVariables.maxDistributionFee });
}
