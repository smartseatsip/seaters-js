...
var FanApi = /** @class */function () {
    ...
    FanApi.prototype.unlinkWaitingListFanAttribute = function (waitingListId, fanAttributeId) {
        return this.apiContext.delete("/profiling/v1/waitinglists/" + waitingListId + "/fan_attributes/" + fanAttributeId, {}, {});
    };
    return FanApi;
}();
...
var FanProfilingService = /** @class */function () {
    ...
    FanProfilingService.prototype.getProfilingCategories = function () {
        var _this = this;
        var categories = [];
        return this.seatersApi.fan.getProfilingCategories().then(function (results) {
            categories = results;
    ...
    FanProfilingService.prototype.createUserFanAttribute = function (userFanAttributeCreateDTO, relationsValidation) {
