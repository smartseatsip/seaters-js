...
let wl: WaitingList = generateWl('wlid-flow-pay-wl-braintree', position, seat);
...
function payForWl (req: RequestOptions): PositionSalesTransaction {
  ...
  let result: PositionSalesTransaction = {
...
export const mocks: Mock[] = [
  ...
  mkMock('GET', '/api/fan/waiting-lists/wlid-flow-pay-wl-braintree/position/payment-info', () => {
    return {
      status: 200,
      statusText: 'OK',
