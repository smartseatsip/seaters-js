...
export const waitingListWithoutSeat = generateWl("waiting-list-without-seat", preauthorizedPosition, null);

export const waitingListsWithSeat = mkPagedResult([waitingListWithSeat]);

export const waitingListsWithoutSeat = mkPagedResult([waitingListWithoutSeat]);
