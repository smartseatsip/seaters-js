    ...
    return (
      ...
      ib(function(a) {
        ...
        jb(L, function(a, b, c) {
          ...
          return c
            ? void 0
            : !0 === a[b] ? b.toLowerCase() : (d = a.getAttributeNode(b)) && d.specified ? d.value : null;
        }),
      fb
    );
  })(a);
          ...
          2 !== t &&
            ...
            j
              ? (k.ifModified &&
                ...
                204 === a || 'HEAD' === k.type
                  ? (x = 'nocontent')
                  : 304 === a ? (x = 'notmodified') : ((x = u.loadingState), (r = u.data), (s = u.error), (j = !s)))
    ...
    (t.version = '0.5.3'),
      ...
      (t.Vector.prototype.dot = function(t) {
        for (var e = this.list, n = t.list, i = 0; e && n; )
          e.idx < n.idx
            ? (e = e.next)
            : e.idx > n.idx ? (n = n.next) : ((i += e.val * n.val), (e = e.next), (n = n.next));
        return i;
      }),
      ...
      (t.SortedSet.prototype.indexOf = function(t, e, n) {
        ...
        return 1 >= i
          ? r === t ? o : -1
          : t > r ? this.indexOf(t, o, n) : r > t ? this.indexOf(t, e, o) : r === t ? o : void 0;
      }),
      ...
      (MenuSticky.prototype.onResize = function(width, height) {
        ...
        hasPositionSticky
          ? this.stickyMode == StickyMode.Current
            ...
            : this.stickyMode == StickyMode.Secondary ? this.setState('sticky') : this.setState('')
        ...
        13 == e.keyCode || 27 == e.keyCode || 38 == e.keyCode || 40 == e.keyCode
          ? ((preventPress = !0),
            ...
            13 == e.keyCode
              ...
              : 27 == e.keyCode
                ? $field.blur()
                : 38 == e.keyCode ? setCurrentResult(-1) : 40 == e.keyCode && setCurrentResult(1))
          : (preventPress = !1);
      })
