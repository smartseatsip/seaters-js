import { WaitingList } from '../../src/seaters-api/fan';
import { PagedResult } from '../../src/seaters-api';

export const waitingListWithSeat: WaitingList = {
	"groupId": "fan-group",
	"groupName": {
		"en": "Ben's Fangroup",
	...
	"waitingListId": "1806f311-fdbe-46da-af6e-43076999dafc",
	"price": {
		"facialPrice": "10.00",
		"numberOfSeats": 1,
...
export const waitingListWithoutSeat: WaitingList = {
	"groupId": "fc25df56-85b2-492f-8f12-c6b197491adb",
	"groupName": {
		"en": "Ben's Fangroup",
		"nl": "Ben's Fangroup nl",
	},
	...
	"translatedVenueCity": "Bruxelles",
	"venueImageUrl": "https://static.dev-seaters.com/file-dc7a3499-3e97-4eda-899d-b438f6d9f774.png",
	"waitingListId": "86538ced-0641-492a-8e2d-a14796024e58",
	"price": {
		"facialPrice": "10.00",
		"numberOfSeats": 1,
		"totalFacialPrice": "10.00",
	...
	"translatedVenueCountry": "Belgium",
	"seatCategory": "PREAUTH"
}

export const waitingListsWithSeat: PagedResult<WaitingList> = {
    items: [
        waitingListWithSeat
    ],
    itemOffset: 0,
...
export const waitingListsWithoutSeat: PagedResult<WaitingList> = {
    items: [
        waitingListWithoutSeat
    ],
    itemOffset: 0,
    totalSize: 1,
    maxPageSize: 10
